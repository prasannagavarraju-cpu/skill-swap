    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400">Manage your swap requests</p>
        </div>
        <Link
          href="/post-skill"
        ...
        {(["received", "sent"] as const).map((t) => (
          <button
            ...
            className={`px-5 py-2 rounded-xl text-sm font-medium transition-all ${
              tab === t ? "bg-indigo-600 text-white" : "glass text-gray-400 hover:text-white"
            }`}
          >
      ...
      {displayed.length === 0 ? (
        <div className="text-center py-16 glass rounded-2xl">
          ...
          <p className="text-gray-400">No {tab} requests yet.</p>
        </div>
      ) : (
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      {tab === "received" ? "wants" : "you requested"} · <span className="text-indigo-400">{req.skill.title}</span>
                    </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {req.status === "ACCEPTED" && (
                    <button
                      ...
                      className="px-3 py-1.5 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-400 text-xs rounded-lg transition-colors"
                    >
                      Mark done
                    </button>
                  )}
