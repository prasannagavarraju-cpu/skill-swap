    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="glass rounded-2xl p-8 mb-8 flex flex-col sm:flex-row items-center sm:items-start gap-6">
        ...
        <div className="text-center sm:text-left">
          ...
          <div className="flex flex-wrap gap-2 mt-3 justify-center sm:justify-start">
            <span className="px-3 py-1 bg-indigo-500/10 text-indigo-400 text-xs rounded-lg">Member</span>
          </div>
        </div>
      </div>
      ...
      {mySkills.length === 0 ? (
        <div className="glass rounded-2xl p-12 text-center">
          ...
          <p className="text-gray-400 mb-4">You haven&apos;t posted any skills yet.</p>
          <a
            href="/post-skill"
